    ...
    <nav className="bg-white border-b border-gray-200 fixed w-full z-10">
        <div className="flex flex-wrap items-center justify-between px-4 py-2.5 md:px-6 max-w-3xl mx-auto sm:px-6 lg:max-w-5xl lg:px-0">
            ...
            <div className={`${showNavbar ? '' : 'hidden'} w-full md:block md:w-auto`}>
                <ul className="flex flex-col p-4 mt-4 border md:mr-10 border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white">
                    <li>
                    ...
                    <li>
                    <a href="#" className="block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Pricing</a>
                    </li>
                    <li>
